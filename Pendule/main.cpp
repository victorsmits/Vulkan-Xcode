...
//		deviceFeatures.wideLines = VK_TRUE; //HERE
	...
	void createTextureImage() {
		...
		stbi_uc* pixels = stbi_load("/Users/victorsmits/Dropbox/ECAM/MIN 4/GPU computing/Programmation parallèle, OpenGL/vulkan/Pendule/textures/normal.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
		VkDeviceSize imageSize = texWidth * texHeight * 4;
		stbi_uc* normals = stbi_load("/Users/victorsmits/Dropbox/ECAM/MIN 4/GPU computing/Programmation parallèle, OpenGL/vulkan/Pendule/textures/normal.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
